...
fun getInitialBusStops(context: Context) : List<Stop> {
...
fun getInitialTramStops(context: Context) : List<Stop> {
    ...
    return tramStopEntities
}


@Serializable
data class StopsJson(val version: String, val recordedAt: String, val stops: List<StopJson>)
