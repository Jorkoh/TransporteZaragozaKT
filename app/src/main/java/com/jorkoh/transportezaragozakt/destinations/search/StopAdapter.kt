...
class StopAdapter(
    ...
    private var displayedStops: List<StopWithoutLocation> = listOf()
    private var stopsFull: List<StopWithoutLocation> = listOf()
    ...
    fun setNewStops(newStops: List<StopWithoutLocation>) {
    ...
    override fun getFilter(): Filter = object : Filter() {
        ...
        override fun publishResults(constraint: CharSequence?, results: FilterResults?) {
            @Suppress("UNCHECKED_CAST")
            val filteredStops = results?.values as List<StopWithoutLocation>
