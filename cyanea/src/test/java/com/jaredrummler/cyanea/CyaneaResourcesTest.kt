...
class CyaneaResourcesTest {
    ...
    @Test
    fun `should return color drawables for background colors`() {
    ...
    @Test
    fun `cyanea resources should return cyanea primary color`() {
        val resources = CyaneaResources(res)
    ...
    @Test
    fun `cyanea resources should return cyanea accent color`() {
        val resources = CyaneaResources(res)
