...
public abstract class MaterialIntroActivity extends AppCompatActivity {
    ...
    private void initOnPageChangeListeners() {
        ...
        viewPager.addOnPageChangeListener(new ViewBehavioursOnPageChangeListener(adapter)
                ...
                .registerPageSelectedListener(new AnimatedVectorDrawableStarterListener())
    ...
    private class AnimatedVectorDrawableStarterListener implements IPageSelectedListener {
        @Override
        public void pageSelected(int position) {
            SlideFragmentBase slideFragment = adapter.getItem(position);
            if (slideFragment instanceof SlideFragment) {
                ((SlideFragment) slideFragment).startAnimation();
            }
        }
    }
